# Contributing to `unetvit4sclera`.
...
## New issues
* Open an issue (bug report, feature request, or something is not working): https://github.com/oocular/unetvit4sclera/issues/new/choose
...
9.1 You can navigate branches in https://github.com/oocular/unetvit4sclera/branches and removed merged branches by clickling :wastebasket: icon.    
